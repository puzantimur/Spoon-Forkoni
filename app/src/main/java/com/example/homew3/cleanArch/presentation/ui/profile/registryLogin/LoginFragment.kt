...
import com.example.homew3.databinding.FragmentLoginBinding
                ...
                when (lce) {
                    is Lce.Content -> {
                        Toast
                            ...
                            .show()
                        findNavController().navigate(LoginFragmentDirections.toStartFragment())
                    }
                    is Lce.Error -> Toast
                        .makeText(requireContext(), "There is no user like this", Toast.LENGTH_SHORT)
                        .show()
                    Lce.Loading -> null
                }
            }
