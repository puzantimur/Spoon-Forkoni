...
import com.example.homew3.cleanArch.presentation.ui.equipment.EquipmentAdapter
import com.example.homew3.cleanArch.presentation.ui.ingredients.IngredientsAdapter
...
class StepsViewHolder(
    ...
    fun bind(item: Step) {
        ...
        with(binding) {
            ...
            step.append(item.number.toString()).toString()
            val adapterIngredients = IngredientsAdapter(context)
            recyclerViewIngredients.addItemDecoration(
                object : RecyclerView.ItemDecoration() {
                    override fun getItemOffsets(
                        ...
                        outRect.left = context.resources.getDimension(R.dimen.default_padding)
                            .toInt()
                        outRect.right = context.resources.getDimension(R.dimen.default_padding)
                            .toInt()
                    }
                }
            )
            ...
            recyclerViewEquipment.addItemDecoration(
                object : RecyclerView.ItemDecoration() {
                    override fun getItemOffsets(
                        outRect: Rect,
                        view: View,
